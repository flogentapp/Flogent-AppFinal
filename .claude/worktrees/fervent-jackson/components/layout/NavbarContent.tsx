...
import { Building2, LogOut, Menu, X, Home, Clock, Shield, Check } from 'lucide-react'
...
export function NavbarContent({ userEmail, userName, currentCompany, availableCompanies }: NavbarContentProps) {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="space-y-1">
                                        <Link onClick={() => setIsOpen(false)} href="/admin/companies" className={`flex items-center gap-3 px-3 py-2 rounded-lg ${isActive('/admin')}`}>
