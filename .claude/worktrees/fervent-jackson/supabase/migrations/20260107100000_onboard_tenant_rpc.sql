-- Onboarding RPC Function (Strictly Aligned with Perfect Schema)
-- This function handles the atomic creation of a tenant, company, profile, and initial roles.
-- It is marked as SECURITY DEFINER to bypass RLS safely for the initial setup.
...
BEGIN
    ...
    INSERT INTO profiles (
        ...
        p_first_name,
        p_last_name,
        'active', -- matches user_status enum
        v_user_id,
        v_company_id
    )
    ...
    INSERT INTO user_role_assignments (
        ...
        'CEO',
        'company',
        v_company_id, -- mapped to scope_id
        v_tenant_id,
        v_user_id
    );
    ...
    -- Signal schema reload for PostgREST
