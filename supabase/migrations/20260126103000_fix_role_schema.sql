-- FIX: Role Assignment Schema (Use scope_id)
...
BEGIN
    ...
    -- 8. Assign CEO Role (CORRECTED SCHEMA)
    -- Using scope_id instead of company_id
    INSERT INTO user_role_assignments (
        user_id,
        role,
        scope_type,
        scope_id,     -- CORRECT COLUMN
        tenant_id,    -- Keep tenant_id as it exists in admin actions
        created_by
    ) VALUES (
        v_user_id,
        'CEO',
        'company',
        v_company_id, -- Value for scope_id
        v_tenant_id,
        v_user_id
    );
